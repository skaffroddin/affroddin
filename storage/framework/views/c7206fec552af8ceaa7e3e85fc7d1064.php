...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" class="border p-4 bg-light shadow-sm">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php /**PATH /home/affy/Desktop/Affroddin/resources/views/register.blade.php ENDPATH**/ ?>